<template>
  <el-container>
    ...
    <public-dialog title="导入JSON" :show.sync="showUpload" width="70%">
      <template slot="body">
        <ace-editor id="uploadAceEditor" ref="uploadAceEditor" :data="uploadJson" />
      </template>

      <template slot="action">
        <el-button size="small" type="primary" @click="handleUploadJson">确定</el-button>
    ...
    <!-- 预览 -->
    <public-dialog title="预览" class="preview-dialog" fullscreen :show.sync="showPreview" width="70%">
      <template slot="body">
        <generate-form
          ref="generateForm"
          :data="data"
      ...
      <template slot="action">
        <el-button size="small" type="primary" @click="handleGetData">获取数据</el-button>
    ...
    <public-dialog title="表单数据" :show.sync="showPreviewData" width="70%">
      ...
      <template slot="action">
        <el-button size="small" class="copyData" type="primary" @click="handleCopyData">复制</el-button>
      </template>
    </public-dialog>
    ...
    <public-dialog title="生成JSON" :show.sync="showJson" width="70%">
      ...
      <template slot="action">
        <el-button size="small" type="primary" class="copyJson" @click="handleCopyJson">复制</el-button>
      </template>
    </public-dialog>
    ...
    <public-dialog title="生成代码" :show.sync="showCode" width="70%">
      ...
      <template slot="action">
        <el-button size="small" type="primary" class="copyCode" @click="handleCopyCode(active)"
          >复制</el-button
        >
      </template>
    </public-dialog>
      ...
      function getOption(list) {
        list.forEach(element => {
          if (element.type === 'cascader') {
            remoteOption[element.options.remoteOption] = deepClone(cascaderOption)
          }
